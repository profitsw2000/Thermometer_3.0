...
#define MEMORY_INDICATION_TRESHOLD				0x10000
#define MEMORY_INDICATION_FREQ_NUMBER			0x10
#define LED_LIGHTNING_COEF						2
#define MEMORY_PART_SIZE						(TOTAL_MEMORY_SIZE - MEMORY_INDICATION_TRESHOLD)/MEMORY_INDICATION_FREQ_NUMBER
