...
/****************************************************************************
 Проверка текущего времени и даты. Если текущий год меньше чем 20 (т.е. либо первое включение, либо датчик работает без батарейки),
 установить время разработчика. 
****************************************************************************/
void Check_time(void)
{
	uint8_t buf[8]	;
	
	//Считать с датчика время, а потом, в случае необходимости, записать своё.
	...
	//если год меньше 20 - установить новое время и дату
	if (buf[7] < 0x20)
	{
